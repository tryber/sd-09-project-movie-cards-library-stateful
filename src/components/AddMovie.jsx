...
return (<div>
  <form data-testid="add-movie-form">
    <label htmlFor="Título" data-testid="title-input-label">
      <input id="Título" type='text' value={ title }
       data-testid="title-input" onChange={ title } >
      </input>
    </label>
    ...
    <textarea  id="Sinopse" value={ storyline }
    data-testid="storyline-input" onChange={ storyline } >
    </textarea>
    </label>
    <label htmlFor="Avaliação" data-testid="rating-input-label">
      <input id="Avaliação" type='number' value={ rating }
      data-testid="subtitle-input" onChange={ rating } >
      </input>
    </label>
